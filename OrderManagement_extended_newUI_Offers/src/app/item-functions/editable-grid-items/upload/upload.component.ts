...
import { INSERT_FAILED, INSERT_SUCCESS, ITEMS_INSERTED, UNKNOWN } from '../../../constants/notifications';
@Component({
  selector: 'app-upload',
  standalone: true,
...
try{
 ...
 if(error.status==400)
 {
  this.toastr.error(error.error,INSERT_FAILED,{ 
    timeOut: 3000,
     positionClass: 'toast-top-right'
  });
 }
 ...
 {
  this.toastr.error(UNKNOWN,INSERT_FAILED,{ 
    timeOut: 3000,
     positionClass: 'toast-top-right'
  });
 }
